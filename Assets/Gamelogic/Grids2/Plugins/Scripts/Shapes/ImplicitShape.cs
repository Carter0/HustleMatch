...
namespace Gamelogic.Grids2
{
	...
	public static class ImplicitShape
	{
		...
		/// <summary>
		/// Represents a 1D translation shape.
		/// </summary>
		...
		/// <summary>
		/// Represents a 2D translation shape.
		/// </summary>
		...
		/// <summary>
		/// Represents a 3D translation shape.
		/// </summary>
		...
		private sealed class ProductShape3 : IImplicitShape<GridPoint3>
		{
			...
			public ProductShape3(
				IExplicitShape<GridPoint3> shape1, 
				IImplicitShape<GridPoint3> shape2, 
				GridPoint3 scaleFactor)
			{
				var translationShapes = shape1
					.Points
					.Select(point => shape2.Translate(point.Mul(scaleFactor)));
		...
		/// <summary>
		/// It represent a 2D half-plane shape
		/// </summary>
		...
		/// <summary>
		/// Represents a generic Function Shape, a shape that can hold a function to be
		/// applied to the points of the shape.
		/// </summary>
		/// <typeparam name="TPoint">Type of the point used.</typeparam>
		...
		[Version(2, 2)]
		[Obsolete("Use PointyHexFatRectangle instead")]
		...
		/// <remarks>Each second row has one more cell than the given width, making 
		/// the rectangle "fat", but more symmetrical than an ordinary rectangle.</remarks>
		[Version(2, 3, 8)]
		...
		[Version(2, 2)]
		[Obsolete("Use PointyHexRectangle instead")]
		public static IImplicitShape<GridPoint2> HexRectangle(GridPoint2 dimensions)
		{
			return PointyHexRectangle(dimensions);
		}
		...
		/// </summary>
		/// <param name="dimensions">The width and height of the rectangle.</param>
		/// <remarks>Each row has the same number of cells.</remarks>
		[Version(2, 3, 8)]
		...
		[Version(2, 2)]
		[Obsolete("Use PointyHexThinRectangle instead")]
		public static IImplicitShape<GridPoint2> HexThinRectangle(GridPoint2 dimensions)
		{
			return PointyHexThinRectangle(dimensions);
		}
		...
		/// </summary>
		/// <param name="dimensions">The width and height of the rectangle.</param>
		/// <remarks>Each second row has one less cell than the given width, making 
		/// the rectangle "thin", but more symmetrical than an ordinary rectangle.</remarks>
		[Version(2, 3, 8)]
		...
		/// </summary>
		/// <param name="dimensions">The width and height of the rectangle.</param>
		/// <remarks>Each second column has one more cell than the given height, making 
		/// the rectangle "fat", but more symmetrical than an ordinary rectangle.</remarks>
		[Version(2, 2)]
		...
		/// </summary>
		/// <param name="dimensions">The width and height of the rectangle.</param>
		/// <remarks>Each column has the same number of cells.</remarks>
		[Version(2, 2)]
		...
		/// </summary>
		/// <param name="dimensions">The width and height of the rectangle.</param>
		/// <remarks>Each second column has one less cell than the given height, making 
		/// the rectangle "thin", but more symmetrical than an ordinary rectangle.</remarks>
		[Version(2, 2)]
		...
		/// </summary>
		/// <param name="shapes">The shapes to stack.</param>
		[Version(2, 2)]
		...
		/// </summary>
		/// <param name="shape">The shape to stack.</param>
		/// <param name="layerCount">The number of layers in the resulting shape</param>
		[Version(2, 2)]
		...
		/// </summary>
		/// <remarks>
		/// If a point p belongs to this shape, and projection(q) equals p, then
		/// q belongs to the returned shape. For example, to get a shape that is translated by (4, 0), 
		/// you need to pass the projection <c>point =&gt; point - new GridPoint(4, 0)</c>
		/// </remarks>
		[Version(2, 3)]
