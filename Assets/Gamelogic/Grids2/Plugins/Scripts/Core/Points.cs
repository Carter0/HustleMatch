...
{
	//TODO: Provide Vector2 versions of norms.
	/// <summary>
	...
	public static class PointyHexPoint
	{
		...
		/// <summary>
		/// Returns the Hex-Manhatten norm of a point, defined by how many 
		...
		/// </summary>
		/// <remarks>
		/// All the points that satsify <c>UpTriPseudoNorm(p) &lt; r</c> form a up triangle
		...
		/// </summary>
		/// <remarks>
		/// All the points that satsify <c>DownTriPseudoNorm(p) &lt; r</c> form a down triangle
		/// in a pointy hex grid.
		/// </remarks>
		...
		/// </summary>
		/// <remarks>
		/// All the points that satsify <c>DownTriPseudoNorm(p) &lt; r</c> form a six-pointed star
		/// in a pointy hex grid.
		/// </remarks>
